...
INSERT INTO "new_OrderItem" ("discount_price", "id", "label_price", "product_id", "quantity", "sell_price") SELECT "discount_price", "id", "label_price", "product_id", "quantity", "sell_price" FROM "OrderItem";
